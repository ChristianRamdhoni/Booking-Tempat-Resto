...
$q_kuota= mysqli_query($mysqli,"SELECT kuota FROM kuota_paledang ORDER BY id_user_kuota ASC limit 1") or die (mysqli_error($mysqli)) ;
	...
	Sisa <?=$sisa_kuota; ?> Pendaftaran Lagi!
		...
		<form action="#" method="post">
			...
			<div class="clear"></div>
				...
				<div class="form-left-w3l">
				<input type="text" class="top-up" name="cabang" value="@Paledang" readonly required="">
				</div>

...
$q_kuota= mysqli_query($mysqli,"SELECT kuota FROM kuota_dramaga ORDER BY id_user_kuota ASC limit 1") or die (mysqli_error($mysqli)) ;
	...
	<div class="appointment-w3">
		<form action="#" method="post">
			<div class="personal">
				<div class="main">
					...
					<div class="form-right-w3ls ">
						<input class="buttom" type="text" name="nomor_hp" value="" placeholder="Nomor yang bisa dihubungi" >
					</div>
				</div>
			</div>
			<div class="information">
				...
				<div class="main">
					<div class="form-left-w3l">
						<select class="form-control" name="tamu" required >
			...
			<div class="form-left-w3l">
				<input type="text" class="top-up" name="cabang" value="@Dramaga" readonly required="">
			</div>
			<div class="btnn">
